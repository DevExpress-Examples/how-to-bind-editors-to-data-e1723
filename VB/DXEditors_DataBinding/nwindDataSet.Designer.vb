...
Namespace DXEditors_DataBinding
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddProductsRow(ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal parentCategoriesRowByCategoriesProducts As CategoriesRow) As ProductsRow
				Dim rowProductsRow As ProductsRow = (CType(Me.NewRow(), ProductsRow))
				Dim columnValuesArray() As Object = { ProductName, UnitPrice, Nothing}
	...
	End Class
End Namespace
Namespace DXEditors_DataBinding.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        ProductName, UnitPrice, CategoryID" & Constants.vbCrLf & "FROM            Products"
